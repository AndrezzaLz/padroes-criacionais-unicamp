...
public class JsonRelatorioGenerator implements RelatorioGenerator {
    ...
    public String gerar(Relatorio relatorio) {
        ...
        sb.append("{\n");
        sb.append("  \"titulo\": ")
                .append(jsonString(relatorio.getTitulo()))
                .append(",\n");

        sb.append("  \"tipo\": ")
                .append(jsonString(relatorio.getTipo().name()))
                .append(",\n");

        sb.append("  \"dataGeracao\": ")
                .append(jsonString(relatorio.getDataGeracao().toString()))
                .append(",\n");

        sb.append("  \"conteudo\": ")
                .append(jsonString(relatorio.getConteudo()))
                .append("\n");
